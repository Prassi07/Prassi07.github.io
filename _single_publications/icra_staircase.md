...
<div class="pastel-card-inner" style="display: flex; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1.5rem;">
    <div class="clearfix" style="text-align: center; flex: 1; min-width: 280px;">
    ...
    <img class="project_pic" style="width: 100%; max-width: 500px; height: auto; object-fit: contain; border-radius: 8px; margin: 0 auto;" src="/images/staircase_results_animation.gif" alt="" />
</div>
...
<div class="pastel-card-inner" style="display: flex; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1.5rem;">
    ...
    <img class="project_pic" style="width: 100%; max-width: 500px; height: auto; object-fit: contain; border-radius: 8px; margin: 0 auto;" src="/images/staircase_merging_animation.gif" alt="" />
</div>
